...
2학기부터 에드캔은 이렇게 활동할 예정입니다
======
* 안드로이드 어플리케이션 개발 (강의: 오준석)
* 안드로이드 플랫폼(커스텀롬) 개발 (강의: 오준석, 박지수)
* 웹 (JavaScript, PHP, Node.JS, Python) 외 (강의: 진상현, 박지수)
* 어플리케이션 UI/UX 구상 및 디자인 (강의: 구창림)

박지수
======
* 부장, 안드로이드 어플리케이션, 웹해킹 파트, 강의
* 처음 이 EDCAN이라는 동아리를 만들기 전에는 약간 망설여졌습니다. 과연 이 애들과 내가 동아리를 처음 만들어서 재대로 할 수 있을까. 불안한 마음에 원래 알고 지냈던 타 동아리의 선배들께도 많이 여쭤보았습니다. 반반인 확률을 안고, 처음으로 동아리 활동을 시작하였을때, 점차 그 불안은 사라지기 시작하였습니다. 나름 잘 따라와 주던 친구들을 보며, 저도 열심히 해야겠다 생각하여, 아이들을 가르치기 위해 필요한 저만의 지식들을 점차 넓혀가기 시작하였습니다. 그리고, 융합클러스터 대회에서 우수한 성과를 거두고, 교내 모바일 컨테스트 대회 은상 수상, 교내 해커톤 대회 금/은/동상을 수상하는 등의 여러 성과를 거둘수 있게 되었습니다.
이러한 것을 통하여, 저에게 기술적인 지식을 비롯해, 아이들과 어울리는 법 같은 많은 것을 배우게 해준 EDCAN이지만, 가장 크게 배워간 것은 인간관계와 할 수 있다는 의지였다고 생각합니다.

오준석
======
* 부부장, 안드로이드 어플리케이션, 웹해킹 파트, 강의
* 선린에 입학할 당시, 자유로운 분위기의 학교생활에 굉장히 기대하며 입학했습니다. 그리고 친구들이랑 "안드로이드 어플리케이션, 플랫폼 개발"이라는 주제를 가지고 동아리 신설이라는 새로운 도전을 해보게 되었습니다. 많은 걱정이 되긴 하였으나, 열심히 활동한 결과 불안보다는 자신감이 생기기 시작했습니다. 동아리 시간에 안드로이드 기초 지식 (레이아웃 구성, 기본 Widget 사용 방법)부터 시작하여 실전에 사용되는 여러가지 (Web-Parsing, 라이브러리 사용 등)를 배웠으며, 또한 서버단과 연동하여 동작하는 어플리케이션 제작까지 많은 것들을 배웠고, 이를 이용해 교내외의 여러 대회 (대한민국 SW융합 클러스터대회, 선린 모바일 콘텐츠 경진대회, SK 앱잼 등등)에 출전하였습니다. 이런 많은 경험들을 통해 많은것을 배우고 느꼈는데, 단체 내에서의 책임감과 서로간의 존중과 배려의 중요성이 가장 크게 다가왔습니다. 추후에는 안드로이드 플랫폼단 작업이나 Web에 사용되는 Node.JS, JQuery, PHP, Python 등의 언어를 동아리 친구들이랑 공부해 나갈 예정입니다.  

김민석 
======
* 안드로이드 어플리케이션, 웹해킹 파트
* 선린에 와서 EDCAN이라는 동아리를 들어간 이후로, 약 4개월 동안 활동하며 선배에게서 안드로이드에 대해서 배웠습니다.
처음에는 LinearLayout을 이용하여 A1-A2-A3처럼 나누어지는 LinearLayout WeightSum을 이용한 화면 분할, orientation으로 화면 정렬하는 방법에 대해 배웠다. 그 후, 안드로이드 XML에서 Widget 사용에 대한 많은 공부를 하였고, ArrayList를 이용하여 이미지 배열을 사용하는 방법, Java Class 사용 방법, Web-Parsing, Animation 사용 방법에 대해 배웠습니다. 그리고 이를 기반으로 하여 이번 선린 모바일 콘텐츠 경진대회에 팀을 구성하여 출전하였고, 이로 인해 기획자, 개발자, 디자이너가 협력하는 방법에 대해 배웠습니다. EDCAN에 들어와서 배우는 동안 개발 능력이 상향된 것 같고, 공동체 정신을 가지게 되의의었습니다. 이후로는 EDCAN에서 현재 공부와 병행하여 Python공부를 조금 더 하고 싶습니다.
...
======
* 디자인 파트
* 저는 EDCAN에 들어와서 구글의 머테리얼 디자인 가이드에 따라 디자인하는 어플리케이션 디자인 방법을 배웠습니다. 그리고 저의 작업물을 보고 피드백을 받으며 어느 부분이 문제인지, 어느 부분을 고치면 나아질지 고민하며 더 좋은 작업을 만들려고 노력했습니다. 또한 여러 대회에 참가하며 협업에 대한 경험이 많이 늘었습니다. 덕분에 동아리는 많은 사람과 작업을 해본적이 없던 저에게 협업을 하는 방법을 알게 해 주었습니다. 활동하면서 많은 경험과 지식을 습득했기에, 앞으로도 저는 에드캔에서 디자이너로 활동하면서 많은 성과를 내여 동아리의 위상을 드높이고 싶습니다!
...
======
* 기획 파트
* 저는 1학기를 보내며 동아리를 하는 동안 생각보다 많은 것을 배웠습니다. 그 중에서 가장 큰 경험을 했던 것은 팀원들과의 협업이 아닐까 싶습니다. 팀원들과 함께 프로젝트를 진행하며 어떻게 하면 효율적으로 소통하고 일을 할 수 있는지에 대해 알게 되었습니다. 또한 기획자로써 기획을 해보며 다듬과, 진행할 떄 어떤 기획이 좋은 기획이고 어떤 부분이 쓸모없는 부분인지, 어떻게 프로젝트를 진행하야 하는가에 대해서도 배웠습니다. 한학기동안 동아리원들과 사이좋게 지내며 배운것이 많은 만큼, 앞으로도 잘 성장할 수 있을거라고 생각합니다. 
